...
<body>
<meta charset=utf-8>
<font size=7 color=red> Relatório de pets cadastrados - Usuario logado - <?php require('verifica.php'); 
echo $_SESSION["nome_usuario"]; echo $_SESSION["UsuarioNivel"]; include('config.php');
